...
final class Config
{
	...
	public string $remnuxSharedHostPath = ''; // Host-side shared folder (e.g. /home/you/dfir-copilot/cases)
	public string $remnuxSharedVMPath = ''; // VM-side mount point   (e.g. /mnt/shared)
	...
	public static function load(string $path = 'config.json'): self
	{
		...
		$map = [
			...
			'remnux.shared_host_path' => 'remnuxSharedHostPath',
			'remnux.shared_vm_path' => 'remnuxSharedVMPath',
	...
	/** Whether REMnux shared folder is configured. */
	public function hasREMnuxSharedFolder(): bool
	{
		return $this->remnuxSharedHostPath !== '' && $this->remnuxSharedVMPath !== '';
	}
